...
export class ServicosService {
    private servicos: Servico[] = [
        {
            ...
            "descricao": "Consulta médica para avaliação de sintomas, diagnóstico e prescrição de tratamento.",
            "duracao": 30,
        },
        {
            id: 2,
            "nome": "Atendimento Psicológico",
            "descricao": "Sessões de psicoterapia para apoio emocional, orientação e desenvolvimento pessoal.",
            "duracao": 50,
        },
        {
            id: 3,
            "nome": "Atendimento Odontológico",
            "descricao": "Sessões de odontologia para cuidados dentários, incluindo limpeza, restaurações e tratamentos preventivos.",
            "duracao": 40,
        },
        {
            id: 4,
            "nome": "Atendimento de Enfermagem",
            "descricao": "Serviço de enfermagem para cuidados básicos, administração de medicamentos e monitoramento de pacientes.",
            "duracao": 20,
        }
    ]
    ...
    atualizarServico(id: number, updateServicoDto: UpdateServiceDto) {
        ...
        let servicoAtualizado: Servico = { ...servico, ...UpdateServicoDto };
